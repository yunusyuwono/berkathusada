            ...
            <div class="card-body mt-2">
                ...
                <div id="fso" style="display:none;">
                    <form method="post">
                        ...
                        <div class="form-group">
                            <input type="hidden" name="lokasi" class="form-control" required value="Praktek">
                        </div>
                        <div class="form-group">
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-hover table-bordered">
                        ...
                        <?php 
                        $no=1;
                        $so=mysqli_query($kon,"select * from so_master where lokasi='Praktek' order by id desc");
