...
else
{
	...
	while($t=mysqli_fetch_array($tpelanggan))
	{
		...
		<tr>
			...
			<td>
				<a class="btn btn-sm btn-warning" href="?hal=pelanggan&edit&id=<?php echo $t['id'];?>"><i class="fas fa-edit"></i></a>
				<a class="btn btn-sm btn-danger" onclick="return confirm('Anda akan menghapus data ini?')" href="pelanggan.aksi?a=del&id=<?php echo $t['id'];?>"><i class="fas fa-trash"></i></a>
			</td>
		</tr>
		<?php
		$no++;
