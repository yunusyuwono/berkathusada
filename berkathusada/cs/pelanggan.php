			...
			<div id="fpelanggan"  style="display: none;">
				...
				<div class="row justify-content-center">
					...
					<div class="form-group col-md-6">
						...
						<input type="radio" name="jns" id="jns" value="Umum" required checked> Umum<br>
						<input type="radio" name="jns" id="jns" value="BPJS" required> BPJS
					</div>
					<div class="form-group col-md-6">
						<label>No. BPJS <small class="text-danger">* Kosongkan jika Umum</small></label>
						<input type="number" required name="nobpjs" id="nobpjs" class="form-control" placeholder="No.BPJS">
					</div>
   ...
   <script>
                $(document).ready(function(e)
                {
                    $("#cari").keyup(function()
                    {
                        $("#pelanggandata").show();
                        var x = $(this).val();
                        $('#pelanggandata').html('Sedang mencari... <i class="fas fa-sync-alt fa-spin"></i>');
                        $.ajax(
                            {
                                type:'GET',
                                url:'pelanggan.data.php',
