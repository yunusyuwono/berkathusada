			...
			<div class="col-md-6">
				<nav aria-label="breadcrumb">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item active text-white" aria-current="page"><b>Hutang Apotek</b></li>
					</ol>
				</nav>
				<h4 class="text-white">Hutang Apotek</h4></div>
			<div class="col-md-6" align="right">
				<div class="btn-group">
				<a class="btn btn-lg text-white" href="hutang.rekap"><i class="fas fa-print"></i></a>
				</div>
			</div>	
		</div>
	</div>
