			...
			<div class="col-md-6">
				<nav aria-label="breadcrumb">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item active text-white" aria-current="page"><b>Transaksi Apotek</b></li>
					</ol>
				</nav>
				<h4 class="text-white">Transaksi Apotek</h4></div>
			<div class="col-md-6" align="right">
				<div class="btn-group">
				<a class="btn btn-lg text-white" href="apt.transaksi.input"><i class="fas fa-plus-circle"></i></a>
				<a class="btn btn-lg text-white" href="apt.transaksi.rekap"><i class="fas fa-print"></i></a>
				</div>
			</div>
		</div>
	</div>
