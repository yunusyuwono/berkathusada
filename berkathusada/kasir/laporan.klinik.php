            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header bg-primary text-white">
                        <div class="row">
                            <div class="col-md-6">
                            Laporan Transaksi Kasir Klinik
                            </div>
                    ...
                    <div class="card-body">
                        ...
                        if(isset($_GET['cari']))
                        {
                            ...
                            $ktrk=mysqli_query($kon,"SELECT * from klinik_trk where idkasir='$_SESSION[iduser]' and tglfaktur between '$awal' and '$akhir'  and status='selesai'");
                            
                        }
                        else
                        {
                            $ktrk=mysqli_query($kon,"SELECT * from klinik_trk where idkasir='$_SESSION[iduser]' and status='selesai'");
                            
                        }

                        $akum=0;
                        $atrk=mysqli_query($kon,"SELECT * from klinik_trk where idkasir='$_SESSION[iduser]' and status='selesai'");
                        while($a=mysqli_fetch_array($atrk))
                        {
                            $atrkd=mysqli_query($kon,"SELECT * from klinik_trkdetail where faktur='$a[nofaktur]'");
                            $ttl=0;
                            while($ad=mysqli_fetch_array($atrkd))
                            {
                                $ttl=$ttl+$ad['biaya'];
                        ...
                        while ($k=mysqli_fetch_array($ktrk)){
                            ...
                            <?php
                            $ktrkd=mysqli_query($kon,"SELECT * from klinik_trkdetail where faktur='$k[nofaktur]'");
                            $total=0;
                            while ($kd=mysqli_fetch_array($ktrkd)) {
                                ...
                                <tr>
                                    ...
                                    <td style="padding:5px";  align="right"><?=number_format($kd['harga'],0,',','.');?></td>
